    ...
    warmup: [
      {
        ...
        videoUrl: 'https://www.youtube.com/results?search_query=swimming+breathing+drill+beginner',
      },
    ],
    mainSet: [
      {
      ...
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/results?search_query=swimming+flutter+kick+technique+beginner',
      },
      {
        stroke: 'kickboard-flutter',
        laps: 2,
  ...
  },
  {
    ...
    mainSet: [
      ...
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/results?search_query=swimming+arm+pull+technique+freestyle+beginner',
      },
      {
        stroke: 'arm-pull-standing',
        laps: 0,
    ...
    mainSet: [
      {
        ...
        videoUrl: 'https://www.youtube.com/results?search_query=freestyle+swimming+beginner+full+stroke',
      },
      {
        stroke: 'combined-movement',
        laps: 1,
